  ...
  <div class="main-wrap">
    ...
    <div class="main-wrap-container">
      <div class="main-search">
        <Input v-model="search" icon="ios-search" size="large" placeholder="搜索……"
               @on-click="startSearch">{{search}}</Input>
      </div>
      <!-- 主界面表格 -->
    ...
    <modal-component :show="modalShow" :mode="mode" :dataList="dataList" @modalClose="changeModalShow"
                     :currentRow="currentRow" @sentEditData="getEditData">
    </modal-component>
  </div>
